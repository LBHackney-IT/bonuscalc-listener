...
The renaming of `BonusCalcListener` into `SomethingElseListener` can be done by running a Renamer powershell script. To do so:
...
- Test coverage should never go down. (See the [test project readme](BonusCalcListener.Tests/readme.md#Run-coverage) for how to run a coverage check.)
